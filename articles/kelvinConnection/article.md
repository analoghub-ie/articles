...
<br/> <img src="http://localhost:3000/images/kelvinConnection/kelvinUnityGain1.svg" alt="Unity gain buffer schematic" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/kelvinConnection/kelvinUnityGain2.svg" alt="Unity gain buffer schematic with Kelvin connection" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/kelvinConnection/kelvinLDO1.svg" alt="Low dropout regulator (LDO) schematic" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/kelvinConnection/kelvinLDO2.svg" alt="Low dropout regulator (LDO) schematic with Kelvin connection" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/kelvinConnection/kelvinLDOConventionalExample.svg" alt="LDO example (conventional connection)" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/kelvinConnection/kelvinLDOKelvinExample.svg" alt="LDO settling using Kelvin connection" style="display: block; margin-inline: auto; width: min(80%, 180rem)" /> 
