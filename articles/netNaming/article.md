...
<br/> <img src="http://localhost:3000/images/netNaming/renaming-multiple-nets-2.png" disableinvert alt="Creating a pin with the same net name" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/netNaming/renaming-multiple-nets-3.png" disableinvert alt="Renaming a pin to a target name" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/netNaming/bus-naming-1.png" disableinvert alt="Bus nets" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/netNaming/bus-naming-2.png" disableinvert alt="Adding bus name" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/netNaming/bus-naming-3.png" disableinvert alt="Stretching a bus name" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
<p style="display: block; text-align: center">Stretching a bus name</p> 

4. Bus has been created!

<br/> <img src="http://localhost:3000/images/netNaming/bus-naming-4.png" disableinvert alt="Bus naming results" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/netNaming/direct-net-editing.png" disableinvert alt="Bus nets" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
<p style="display: block; text-align: center">Bus nets</p> 
...
<br/> <img src="http://localhost:3000/images/netNaming/multiple-bus-2.png" disableinvert alt="Connecting multiple nets to the bus" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
