...
<br/> <img src="http://localhost:3000/images/currentMirrors/cmSimple.svg" alt="Basic current mirror circuit" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/currentMirrors/cmVdsVariation.svg" alt="Output current variation due to $V_{out}$" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/currentMirrors/cmVdsId.svg" alt="Vds vs Id variation" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/currentMirrors/cmCascodeBias.svg" alt="Cascode current mirror circuit" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/currentMirrors/cmSelfBiased.svg" alt="Self-biased current mirror circuit" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
<p style="display: block; text-align: center">Self-biased current mirror circuit</p>

<br/> <img src="http://localhost:3000/images/currentMirrors/cmExternalBias.svg" alt="Externally biased cascode current mirror" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
