...
<br/> <img src="http://localhost:3000/images/cadenceAnalysisEMIR/EMIR-extraction.png" alt="PEX settings for EMIR analysis" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/cadenceAnalysisEMIR/EMIR-ADEL.png" alt="EMIR analysis settings1" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
<p style="display: block; text-align: center">EMIR analysis settings</p> 


<br/> <img src="http://localhost:3000/images/cadenceAnalysisEMIR/EMIR-setup-1.png" alt="EMIR analysis settings2" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
<p style="display: block; text-align: center">EMIR analysis settings</p> 
