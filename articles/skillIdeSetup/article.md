...
<br/> <img src="http://localhost:3000/images/skillIdeSetup/helloWorldSkill.png" disableinvert alt="Hello World using SKILL" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/skillIdeSetup/loadCodeSkill.png" disableinvert alt="Loading SKILL code" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/skillIdeSetup/outputSkill.png" disableinvert alt="SKILL code output" style="display: block; margin-inline: auto; width: min(80%, 30rem)" /> 
...
<br/> <img src="http://localhost:3000/images/skillIdeSetup/skillApiFinder.png" disableinvert alt="SKILL API finder" style="display: block; margin-inline: auto; width: min(80%, 20rem)" /> 
